...
export default function ChangeAgentCurrency({ isModalOpen, onClose }) {
  ...
  useEffect(() => {
    if (isModalOpen) {
      ...
      const currentAgent = Cookies.get("agent");
  ...
  return (
    ...
    >
      <div className="text-center text-white mb-6">
        <h1 className="text-2xl font-bold mb-2">Select your preferences</h1>
      </div>
